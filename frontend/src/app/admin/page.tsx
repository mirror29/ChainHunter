              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    服务器端定时任务，每6小时自动执行，无需用户在线。
                  </p>
                  <Badge variant="outline" className="mt-2">主要保活</Badge>
                </div>
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <p className="text-sm text-gray-600">
                    使用Uptime Robot等服务监控保活端点。
                  </p>
                  <Badge variant="outline" className="mt-2">额外保障</Badge>
                </div>
              </div>
              
              <div className="p-4 bg-blue-50 rounded-lg">
                <h4 className="font-medium text-blue-800 mb-2">建议配置</h4>
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>• 启用GitHub Actions作为主要保活机制</li>
                  <li>• 第三方监控作为备用方案</li>
                  <li>• 间隔设置为6小时（平衡效果和资源消耗）</li>
                  <li>• 定期检查执行日志和状态</li>
                </ul>
              </div>
            </CardContent>
